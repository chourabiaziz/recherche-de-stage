    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                    ...
                    <ul id="sidebarnav">
                       ...
                       <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="tachesEncadrantStagaire.php"
                                ...
                                <span class="hide-menu">Sujet a faire </span>
                            </a>
                        </li>
                        <li class="sidebar-item">
        ...
        <div class="page-wrapper">
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0" colspan="2">Message</th>
                                ...
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Ecrire msg....</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <textarea rows="2" class="form-control p-0 border-0"></textarea>
                                    <button name=Demande class='btn btn-success'>Repondre</button></div>
                                </div>
            ...
            <footer class="footer text-center"><a
                    href="https://www.uaca.com/">OACA</a>
            </footer>
