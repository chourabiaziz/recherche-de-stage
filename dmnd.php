...
$cin1 = $_POST['v'];
$req="SELECT * FROM demandeatt where CIN = $cin1 limit 1;";
...
$result1=$bdd->exec($req1);
     ...
     /*$sql = "DELETE FROM demandeatt WHERE CIN = '$cin'";
...
?> 
                            ...
                            <div class="d-md-flex mb-3">
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 ms-auto">
                                     <button name="Accepte" class="btn btn-success">Accepte</button>
                                     <button name="Refuse" class="btn btn-success">Refuse</button>
