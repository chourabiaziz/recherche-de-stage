...
<?php
 try{
      ...
      echo "<br>";
       ...
       $v = $_SESSION['encadrant'];

        $res= "SELECT * FROM `encadrant` WHERE mat='$v' limit 1;";
   ...
   if(isset($_POST['b1'])){
         $no = $_POST['v1'];
    if ($no == "") {
        $msg = "<h5><font color = 'red'>Verfier votre informations</font></h5>";
    }else{
   $req="UPDATE encadrant SET nom='$no' WHERE mat='$v'";
   $result=$bdd->exec($req);
   ...
   if(isset($_POST['b2'])){
    ...
    $msg1 = "<h5><font color = 'red'>Verfier votre informations</font></h5>";
    }else{
   $req="UPDATE encadrant SET pass= '$pass' WHERE mat='$v'";
   $result=$bdd->exec($req);
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="white-box">
                                 <h4 class="page-title">Encadreur : <?php echo "<b>". $nom."</b>";?></h4>
                        </div>
                        
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Nom : <?php echo $nom;?></label>
                                        <div class="col-md-12 border-bottom p-0">
                                            
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Matricule : <?php echo $mat;?></label>
                                        <div class="col-md-12 border-bottom p-0">
                                            
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
            <label for="example-email" class="col-md-12 p-0">Domaine : <?php echo $domaine;?></label>
                                        <div class="col-md-12 border-bottom p-0">
                            ...
                            <div class="card-body">
                                <form method="POST" class="form-horizontal form-material">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text"name="v1" placeholder="votre nom"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <input type="text" placeholder="Mot pass nouveau" name="v2" class="form-control p-0 border-0">
