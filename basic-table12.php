...
$msg = "<strong><font color='green'>".$nom."  de numero CIN  ".$cin1."  est ACCEPTE</font> </strong><br>";
}
...
if ($result1) {
   ...
   $result=$bdd->exec($req);
    ...
    $req="update stage1 set nbr = nbr - '1'  where titre = '$titre';";
    $result=$bdd->exec($req);
}
}
...
$titre = $ligne ['titre'];                   
$competonce = $ligne ['competonce'];
$msg = "<strong><font color='red'>".$nom."  de numero CIN  ".$cin1."  est REFUSE</font> </strong><br>";
}
...
$req1 = "INSERT INTO `demanderefuse` (`CIN`, `nomcomlet`, `titre`, `competonce`) VALUES ('$cin1', '$nom', '$titre', '$competonce');";
  ...
  if ($result1){
   ...
   $req="UPDATE total SET totR = totR + '1'";
   $result=$bdd->exec($req);
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion Demandes Stages</h4>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <font color="green"></font>
                             <h5 class="box-title"><?php echo $msg; ?></h5>
                            ...
                            <div class="d-md-flex mb-3">
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 ms-auto">
                                    <select name="v" class="form-select shadow-none row border-top">
                                        <option value="st">selection stagaire</option>
<?php
